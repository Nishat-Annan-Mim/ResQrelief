...
// /* ================================================================
//    ExpiryTimer — shows a live countdown on a "need" request card.
//    Props:
//      expiresAt  – ISO date string from the DB
//      isOwner    – true if the logged-in user created this request
//      onExpired  – callback fired once when the timer hits 0
//    ================================================================ */
// const ExpiryTimer = ({ expiresAt, isOwner, onExpired }) => {
...
//   const isUrgent = secondsLeft <= 300 && !isExpired; // last 5 min
...
//         {isOwner && (
//           <span
//             style={{ display: "block", marginTop: "4px", fontWeight: "400" }}
//           >
//             Please delete it if help is no longer needed.
//           </span>
//         )}
//       </div>
//     );
...
//         padding: "6px 10px",
//         borderRadius: "8px",
//         background: isUrgent ? "#ffe5e5" : "#eaf4ff",
//         border: `1px solid ${isUrgent ? "#f5c6cb" : "#b8d9f5"}`,
//         color: isUrgent ? "#b30000" : "#1a73e8",
//         fontWeight: "700",
//         fontSize: "13px",
//         display: "inline-block",
//       }}
//     >
//       {isUrgent ? "⚠️" : "⏳"} Expires in {pad(minutes)}:{pad(seconds)}
//     </div>
//   );
// };
...
//       );
//       await loadBoard();
//       alert("You confirmed the helper is on the way!");
//     } catch (error) {
//       const msg = error?.response?.data?.message || "Could not confirm help";
//       alert(msg);
//     }
//   };
...
//     } catch (error) {
//       const msg =
//         error?.response?.data?.message || "Could not mark request as helped";
//       alert(msg);
//     }
//   };
...
//             allRequests.map((request) => {
//               const isOwner =
//                 request.createdByVolunteerEmail === volunteerProfile?.email;
...
//                   {/* ── Expiry Timer: only on "need" requests ── */}
//                   {request.status === "need" && request.expiresAt && (
//                     <ExpiryTimer
//                       expiresAt={request.expiresAt}
//                       isOwner={isOwner}
//                       onExpired={() => {
//                         // Silently reload so the expired state refreshes
//                         loadBoard();
//                       }}
//                     />
//                   )}
...
//                   {/* ── Handshake: requester confirms they see the helper ── */}
//                   {request.status === "helping" && isOwner && (
//                     <div
//                       style={{
//                         marginTop: "10px",
//                         padding: "10px 12px",
//                         background: request.requesterConfirmed
//                           ? "#e8f5e9"
//                           : "#fff8e1",
//                         border: `1px solid ${request.requesterConfirmed ? "#a5d6a7" : "#ffe082"}`,
//                         borderRadius: "8px",
//                         fontSize: "13px",
//                       }}
//                     >
...
//                           ✅ You confirmed help is coming. Waiting for helper to
//                           close.
//                         </span>
//                       ) : (
//                         <>
...
//                             }}
//                           >
//                             🤝 A volunteer accepted your request. Can you
//                             confirm they are coming?
//                           </div>
//                           <button
//                             className="helped-btn"
//                             onClick={() => confirmHelp(request._id)}
//                           >
//                             Yes, Confirm Help
//                           </button>
//                         </>
...
//                             }
//                             style={{
//                               opacity: request.requesterConfirmed ? 1 : 0.55,
//                               cursor: request.requesterConfirmed
//                                 ? "pointer"
//                                 : "not-allowed",
//                             }}
//                           >
            ...
            {sharedVolunteers.length === 0 ? (
              ...
              sharedVolunteers.map((vol) => {
                ...
                return (
                  ...
                  >
                    <div className="volunteer-list-name">
                      {isMe ? "You (shared your location)" : vol.fullName}
                    </div>
                    <div className="volunteer-list-address">
                      {vol.currentAddress ||
                        `Lat: ${vol.currentLatitude}, Lng: ${vol.currentLongitude}`}
                    ...
                    >
                      {request.requesterConfirmed ? (
                        ...
                        <>
                          ...
                          >
                            <Handshake size={15} strokeWidth={2} />A volunteer
                            accepted your request. Can you confirm they are
                            coming?
                          </div>
                          <button
                            className="helped-btn"
