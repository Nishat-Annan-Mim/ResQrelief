...
//   // Retrieve user data from localStorage and ensure it's available
//   const user = JSON.parse(localStorage.getItem("user"));
...
//         setValidNidNumbers(response.data);
//         console.log("Fetched NID numbers:", response.data); // Log the fetched NIDs for debugging
//       } catch (error) {
...
//   // Handle phone number input and show relation input when Enter is pressed
//   const handlePhoneSubmit = (e) => {
//     if (e.key === "Enter") {
//       setStep(2); // Move to relation step
//     }
//   };
...
//     // Check if the entered NID exists in the valid NIDs array
//     if (!validNidNumbers.includes(nidNumber)) {
//       setMessage("Invalid NID number. Please try again.");
//       return;
//     }
...
//                     onChange={handleChange}
//                     placeholder="eg. Father, Friend, etc."
//                   />
//                 </div>
//               ) : (
//                 <input
