...
const AdminOperations = () => {
  ...
  const fetchOperations = () => {
    axios
      .get("https://resqreliefcheck.onrender.com/api/operations")
  ...
  const handleSubmit = async () => {
    ...
    await axios.post("https://resqreliefcheck.onrender.com/api/operations", {
  ...
  const deleteOperation = async (id) => {
    ...
    await axios.delete(`https://resqreliefcheck.onrender.com/api/operations/${id}`);
    fetchOperations();
  };
