...
//                       );
//                       setForm({ ...form, scheduledDate: "" });
//                     } else {
//                       setDateError("");
//                       setForm({ ...form, scheduledDate: selected });
//                     }
//                   }}
...
//   // Returns the minimum allowed departure time (current time + 180 min) as "HH:MM"
...
//                     } else {
//                       setDateError("");
//                       // Reset departure time whenever date changes to avoid stale value
//                       setForm({
//                         ...form,
...
//                   type="time"
//                   value={form.departureTime}
//                   // Only restrict min time when today is selected
//                   min={
...
//                     // If today is selected, reject any time that is not strictly in the future
//                     if (isToday(form.scheduledDate)) {
//                       const minTime = getMinDepartureTime();
//                       if (chosenTime < minTime) {
//                         alert(
//                           "⚠️ Departure time must be later than the current time.",
//                         );
